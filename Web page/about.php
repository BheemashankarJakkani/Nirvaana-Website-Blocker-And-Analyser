...
<div class="topnav">
  <a href="http://localhost/search.php#new%20.html" >Home</a>
  <a  href="http://localhost/searchini.php">Search by Link</a>
...
<h2>Responsive "#Vr_G0D_PartiCLes" Team</h2>
...
<div class="row">
  ...
  <div class="column">
      ...
      <div class="container">
        <h2>Akhilesh Raichur</h2>
        <p class="title">Developer</p>
        <p>PES UNIVERSITY</p>
        <p>akhileshraichur@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
