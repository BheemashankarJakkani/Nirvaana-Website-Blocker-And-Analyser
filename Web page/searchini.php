...
$link1 = "http://localhost/search.php";
?>
<html>
<div class="topnav">
  <a href='<?php echo $link1; ?>' >Home</a>
  <a class="active" href="#new .html">Search by Link</a>
...
<center><input type="text" name="search" id="search" placeholder="website address" ></br></br></center>
...
if(isset($_POST["searchbut"]))
{
	...
	$sqli = mysqli_query($conn,"select * from hackbigger where web_host='$_POST[search]'") or die("Error: " . mysqli_error($conn));
